...
long long find(string s,int x,int y){
    int n=s.size();
    vector<int>v01(s.size());
    if(s[0]=='0'){
        v01[0]=1;
    }
    for(int i=1;i<n;i++){
